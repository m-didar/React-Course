                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" className="form-control" validators={{
                                        required,
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" className="form-control" validators={{
                                        required,
                                        minLength: minLength(3),
                                        maxLength: maxLength(15)
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" validators={{
                                        required,
                                        minLength: minLength(3),
                                        maxLength: maxLength(15),
                                        isNumber
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" className="form-control" validators={{
                                        required,
                                        validEmail
